...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] = {
	...
	/* PPME_SYSCALL_ACCESS_E */{"access", EC_FILE, EF_NONE, 0 },
	/* PPME_SYSCALL_ACCESS_X */{"access", EC_FILE, EF_NONE, 3, {{"res", PT_ERRNO, PF_DEC}, {"name", PT_FSPATH, PF_NA}, {"mode", PT_FLAGS32, PF_HEX, access_flags} } }
};
